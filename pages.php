...
if (isset($_POST['about'])) {
	...
	$display = '  <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-4">
            <img src='.$row['file'].' class="img-fluid" alt="">
...
if (isset($_POST['update_id'])) {
    ...
    if($num>0){
        ...
        echo '<div class="row container-fluid"><div class="col-lg-12 col-md-12 col-12">'.$row['content'].'</div></div>';
